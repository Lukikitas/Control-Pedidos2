...
function parseCommand(text) {
  ...
  if (cleanText.includes('rappi cargo') || cleanText.includes('cargo') || cleanText.includes('rapi cargo')) {
    source = 'RappiCargo';
  } else if (cleanText.includes('pedidos ya') || cleanText.includes('pedidosya') || cleanText.includes('pesa') || cleanText.includes('pedido yas') || cleanText.includes('pedidoya') || cleanText.includes('pedido ya') || cleanText.includes('peya')) {
    source = 'PedidosYa';
